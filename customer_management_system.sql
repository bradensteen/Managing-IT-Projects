...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2545384617ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="323d297d217278773d54364b3e364c3a">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="management_system" targettable="">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `user` (
  `id` int(11) NOT NULL,
  ...
  `authtoken` varchar(250) NOT NULL
                            ...
                            targetdb="management_system" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE USER &#039;braden&#039;@&#039;localhost&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT ALL PRIVILEGES ON *.* TO &#039;braden&#039;@&#039;localhost&#039; REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="management_system" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="customer_management_system" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
  ...
  `mobile` varchar(50) NOT NULL
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `customer` WHERE `customer`.`id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer_management_system" targettable="customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `customer` ADD UNIQUE(`email`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer_management_system" targettable="customer">
                            <div class="action_content">
