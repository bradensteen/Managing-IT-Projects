...
if(isset($_POST["update_customer"]) && !empty($_POST["fname"]) && !empty($_POST["lname"]) && !empty($_POST["mobile"]) && !empty($_POST["email"])) {
    $fname = $_POST["fname"];
    $lname = $_POST["lname"];
...
$u_cust = "UPDATE customer
SET email = '$email', password = MD5('$password'), mobile = '$mobile'
WHERE first_name = '$fname' AND last_name = '$lname'";
mysqli_query($con,$u_cust);
