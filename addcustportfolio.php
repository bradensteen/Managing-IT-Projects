...
<?php
    ...
    $project_id = $_GET['id'];
	$result_project = mysqli_query($con, "SELECT * FROM `projects` WHERE `id` = '$TO_FILL'");
						...
						<div class="col-md-12 col-lg-9">
							<h4 class="blue d-flex justify-content-between">
                              ...
                              <div class="profile-user-info">
                                ...
                                <div class="profile-info-row">
									<div class="profile-info-name"> Investment </div>
									<div class="profile-info-value">
										<span>'.$project['invest_desc'].'</span>
									</div>
								</div>
                            </div>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
								  ...
								  <form method="post" action="/db/editProject.php?id='.$project_id.'">
                                      ...
                                      <div class="form-group">
								  	  	<label for="invest_desc">invest description</label>
								  	  	<textarea class="form-control" rows="2" id="invest_desc" name="invest_desc">'.$project['invest_desc'].'</textarea>
                                      </div>
